...
namespace CookedAssetSerializer {
    ...
    public static class Globals {
        ...
        public static string ContentDir = @"F:\DRG Modding\DRGPacker\_unpacked\FSD\Content";
        public static string JsonDir = @"F:\DRG Modding\DRGPacker\JSON\Assets";
    ...
    class Program  {
		...
		static void Main(string[] args) {
            ...
            //ScanAssetTypes(@"F:\DRG Modding\DRGPacker\_unpacked\FSD\Content", globalUE);
            //MoveAssets(@"F:\DRG Modding\DRGPacker\_unpacked\FSD\Content", @"F:\DRG Modding\DRGPacker\JSON\Output",typestocopy,globalUE);
            SerializeAssets(@"F:\DRG Modding\DRGPacker\_unpacked\FSD\Content");
        }
    }
}
