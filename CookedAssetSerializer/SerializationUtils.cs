...
public static class SerializationUtils
{
    ...
    public static List<string> CollectGeneratedVariables(ClassExport mainobject, AssetInfo assetInfo)
    {
        ...
        {
            if (scs is not ObjectPropertyData opd) Debug.WriteLine("!BUG! " + mainobject.ObjectName); // TODO
            else if (FindPropertyData(opd.Value, "AllNodes", out PropertyData allnodes, assetInfo.Asset))
            {
