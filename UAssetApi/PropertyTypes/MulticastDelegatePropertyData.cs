...
public class FMulticastDelegate
{
    ...
    [JsonProperty]
    public FPackageIndex Number;
    /** Uncertain what this is for; if you find out, please let me know */
    [JsonProperty]
    public FName Delegate;

    public FMulticastDelegate(FPackageIndex number, FName @delegate)
    {
        Number = number;
        Delegate = @delegate;
    }
...
public class MulticastDelegatePropertyData : PropertyData<FMulticastDelegate[]>
{
    ...
    public override void Read(AssetBinaryReader reader, bool includeHeader, long leng1, long leng2 = 0)
    {
        ...
        {
            Value[i] = new FMulticastDelegate(reader.XFER_OBJECT_POINTER(), reader.ReadFName());
        }
    }
    ...
    public override int Write(AssetBinaryWriter writer, bool includeHeader)
    {
        ...
        {
            writer.XFER_OBJECT_POINTER(Value[i].Number);
...
public class MulticastInlineDelegatePropertyData : MulticastDelegatePropertyData {
    ...
    private static readonly FName CurrentPropertyType = new FName("MulticastInlineDelegateProperty");
    public override FName PropertyType { get { return CurrentPropertyType; } }
...
public class MulticastSparseDelegatePropertyData : MulticastDelegatePropertyData {
    ...
    private static readonly FName CurrentPropertyType = new FName("MulticastSparseDelegateProperty");
    public override FName PropertyType { get { return CurrentPropertyType; } }
};