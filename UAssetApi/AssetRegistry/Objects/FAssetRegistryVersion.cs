...
{
    private static readonly Guid _GUID = UAPUtils.GUID(0x717F9EE7, 0xE9B0493A, 0x88B39132, 0x1B388107);
    //private static readonly Guid _GUID1 = UAPUtils.GUID(0x17DCDBEC, 0xAFD74303, 0xA052F55F, 0xF99B3CEA);

    public static bool TrySerializeVersion(AssetBinaryReader reader, out FAssetRegistryVersionType version)
    {
        var guid = new Guid(reader.ReadBytes(16));
        //if (guid == _GUID || guid == _GUID1)
        if (guid == _GUID)
        {
            version = (FAssetRegistryVersionType)reader.ReadInt32();
            return true;
        }
