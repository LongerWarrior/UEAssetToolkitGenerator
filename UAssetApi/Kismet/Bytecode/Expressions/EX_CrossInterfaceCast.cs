...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.CrossInterfaceCast"/> instruction.
/// </summary>
public class EX_CrossInterfaceCast : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.CrossInterfaceCast; } }
