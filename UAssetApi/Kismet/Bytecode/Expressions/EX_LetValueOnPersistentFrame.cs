...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.LetValueOnPersistentFrame"/> instruction.
/// </summary>
public class EX_LetValueOnPersistentFrame : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.LetValueOnPersistentFrame; } }
