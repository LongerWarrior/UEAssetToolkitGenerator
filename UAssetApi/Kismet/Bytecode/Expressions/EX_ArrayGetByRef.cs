...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.ArrayGetByRef"/> instruction.
/// </summary>
public class EX_ArrayGetByRef : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.ArrayGetByRef; } }
