...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.RemoveMulticastDelegate"/> instruction.
/// </summary>
public class EX_RemoveMulticastDelegate : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.RemoveMulticastDelegate; } }
