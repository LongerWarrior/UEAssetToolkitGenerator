...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.SetMap"/> instruction.
/// </summary>
public class EX_SetMap : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.SetMap; } }
    ...
    public override void Read(AssetBinaryReader reader)
    {
        ...
        Elements = reader.ReadExpressionArray(EExprToken.EndMap);
    }
