...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.SwitchValue"/> instruction.
/// </summary>
public class EX_SwitchValue : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.SwitchValue; } }
