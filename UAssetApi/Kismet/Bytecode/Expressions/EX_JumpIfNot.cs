...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.JumpIfNot"/> instruction.
/// Conditional equivalent of the <see cref="EExprToken.Jump"/> expression.
/// </summary>
public class EX_JumpIfNot : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.JumpIfNot; } }
