...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.ClassSparseDataVariable"/> instruction.
/// </summary>
public class EX_ClassSparseDataVariable : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.ClassSparseDataVariable; } }
