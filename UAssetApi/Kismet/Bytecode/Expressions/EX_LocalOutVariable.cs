...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.LocalOutVariable"/> instruction.
/// </summary>
public class EX_LocalOutVariable : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.LocalOutVariable; } }
