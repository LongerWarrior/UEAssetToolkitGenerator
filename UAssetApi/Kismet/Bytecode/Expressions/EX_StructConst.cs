...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.StructConst"/> instruction.
/// </summary>
public class EX_StructConst : KismetExpression<KismetExpression[]>
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.StructConst; } }
    ...
    public override void Read(AssetBinaryReader reader)
    {
        ...
        Value = reader.ReadExpressionArray(EExprToken.EndStructConst);
    }
