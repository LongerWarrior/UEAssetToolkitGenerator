...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.DynamicCast"/> instruction.
/// </summary>
public class EX_DynamicCast : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.DynamicCast; } }
