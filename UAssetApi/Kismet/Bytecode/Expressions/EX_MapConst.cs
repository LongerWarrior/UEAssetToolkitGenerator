...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.MapConst"/> instruction.
/// </summary>
public class EX_MapConst : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.MapConst; } }
    ...
    public override void Read(AssetBinaryReader reader)
    {
        ...
        Elements = reader.ReadExpressionArray(EExprToken.EndMapConst);
    }
