...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.SetSet"/> instruction.
/// </summary>
public class EX_SetSet : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.SetSet; } }
    ...
    public override void Read(AssetBinaryReader reader)
    {
        ...
        Elements = reader.ReadExpressionArray(EExprToken.EndSet);
    }
