...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.InterfaceContext"/> instruction.
/// </summary>
public class EX_InterfaceContext : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.InterfaceContext; } }
