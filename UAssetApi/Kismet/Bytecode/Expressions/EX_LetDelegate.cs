...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.LetDelegate"/> instruction.
/// </summary>
public class EX_LetDelegate : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.LetDelegate; } }
