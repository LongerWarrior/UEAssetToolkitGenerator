...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.ObjToInterfaceCast"/> instruction.
...
public class EX_ObjToInterfaceCast : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.ObjToInterfaceCast; } }
