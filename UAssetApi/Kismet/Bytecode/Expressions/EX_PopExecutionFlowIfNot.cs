...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.PopExecutionFlowIfNot"/> instruction.
/// Conditional equivalent of the <see cref="EExprToken.PopExecutionFlow"/> expression.
/// </summary>
public class EX_PopExecutionFlowIfNot : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.PopExecutionFlowIfNot; } }
