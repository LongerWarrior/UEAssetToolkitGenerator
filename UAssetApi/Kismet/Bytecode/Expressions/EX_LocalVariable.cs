...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.LocalVariable"/> instruction.
/// </summary>
public class EX_LocalVariable : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.LocalVariable; } }
