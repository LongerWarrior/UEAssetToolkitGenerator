...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.LetWeakObjPtr"/> instruction.
/// </summary>
public class EX_LetWeakObjPtr : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.LetWeakObjPtr; } }
