...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.Return"/> instruction.
/// </summary>
public class EX_Return : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.Return; } }
