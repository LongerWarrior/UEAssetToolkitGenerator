...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.AddMulticastDelegate"/> instruction.
/// </summary>
public class EX_AddMulticastDelegate : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.AddMulticastDelegate; } }
