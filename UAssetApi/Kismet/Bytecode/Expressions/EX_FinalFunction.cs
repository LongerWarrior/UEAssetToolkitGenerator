...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.FinalFunction"/> instruction.
/// </summary>
public class EX_FinalFunction : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.FinalFunction; } }
