...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.SoftObjectConst"/> instruction.
/// </summary>
public class EX_SoftObjectConst : KismetExpression<KismetExpression>
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.SoftObjectConst; } }
