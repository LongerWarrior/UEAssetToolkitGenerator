...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.ArrayConst"/> instruction.
/// </summary>
public class EX_ArrayConst : KismetExpression<KismetExpression[]>
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.ArrayConst; } }
    ...
    public override void Read(AssetBinaryReader reader)
    {
        ...
        Elements = reader.ReadExpressionArray(EExprToken.EndArrayConst);
    }
