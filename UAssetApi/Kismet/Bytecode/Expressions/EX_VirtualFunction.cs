...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.VirtualFunction"/> instruction.
/// </summary>
public class EX_VirtualFunction : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.VirtualFunction; } }
