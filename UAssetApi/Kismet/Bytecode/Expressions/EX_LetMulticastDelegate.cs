...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.LetMulticastDelegate"/> instruction.
/// </summary>
public class EX_LetMulticastDelegate : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.LetMulticastDelegate; } }
