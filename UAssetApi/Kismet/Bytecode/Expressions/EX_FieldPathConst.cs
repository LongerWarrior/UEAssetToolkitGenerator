...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.FieldPathConst"/> instruction.
/// </summary>
public class EX_FieldPathConst : KismetExpression<KismetExpression>
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.FieldPathConst; } }
