...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.InterfaceToObjCast"/> instruction.
/// </summary>
public class EX_InterfaceToObjCast : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.InterfaceToObjCast; } }
