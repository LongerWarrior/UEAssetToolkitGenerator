...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.PropertyConst"/> instruction.
/// </summary>
public class EX_PropertyConst : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.PropertyConst; } }
