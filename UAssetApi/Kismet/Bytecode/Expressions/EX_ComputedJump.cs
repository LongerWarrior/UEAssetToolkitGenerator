...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.ComputedJump"/> instruction.
/// </summary>
public class EX_ComputedJump : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.ComputedJump; } }
