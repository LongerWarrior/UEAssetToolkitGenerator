...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.PrimitiveCast"/> instruction.
/// </summary>
public class EX_PrimitiveCast : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.PrimitiveCast; } }
