...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.TransformConst"/> instruction.
/// </summary>
public class EX_TransformConst : KismetExpression<FTransform>
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.TransformConst; } }
