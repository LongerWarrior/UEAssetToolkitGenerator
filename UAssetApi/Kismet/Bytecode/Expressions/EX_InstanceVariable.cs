...
/// <summary>
/// A single Kismet bytecode instruction, corresponding to the <see cref="EExprToken.InstanceVariable"/> instruction.
/// </summary>
public class EX_InstanceVariable : KismetExpression
{
    ...
    /// </summary>
    public override EExprToken Token { get { return EExprToken.InstanceVariable; } }
