...
public class ClassExport : StructExport
{
    ...
    public override void Read(AssetBinaryReader reader, int nextStarting)
    {
        ...
        {
            Interfaces[i] = new SerializedInterfaceReference(reader.ReadInt32(), reader.ReadInt32(), reader.ReadIntBoolean());
        }
        if (Asset.EngineVersion < UE4Version.VER_UE4_UCLASS_SERIALIZE_INTERFACES_AFTER_LINKING)
        {
        ...
        bDeprecatedForceScriptOrder = reader.ReadIntBoolean();
