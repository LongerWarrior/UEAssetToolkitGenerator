...
public class StructExport : FieldExport
{
    ...
    public override void Read(AssetBinaryReader reader, int nextStarting)
    {
        ...
        {
#if DEBUG      
            //Debug.WriteLine(reader.BaseStream.Position- startedReading);
            //Debug.WriteLine(startedReading);
