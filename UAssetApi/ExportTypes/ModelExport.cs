...
public readonly struct FLightmassPrimitiveSettings : IUStruct {
    ...
    public FLightmassPrimitiveSettings(AssetBinaryReader reader) {
        ...
        bUseVertexNormalForHemisphereGather = reader.Ver >= UE4Version.VER_UE4_NEW_LIGHTMASS_PRIMITIVE_SETTING && reader.ReadIntBoolean();
...
public class ModelExport : NormalExport {
    ...
    public override void Read(AssetBinaryReader reader, int nextStarting) {
        ...
        var bHasEditorOnlyData = !reader.Asset.PackageFlags.HasFlag(EPackageFlags.PKG_FilterEditorOnly) || reader.Ver < UE4Version.VER_UE4_REMOVE_UNUSED_UPOLYS_FROM_UMODEL;
