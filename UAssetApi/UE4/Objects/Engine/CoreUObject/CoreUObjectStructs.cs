...
// Scriptclass CoreUObject.FrameRate
...
public class FFrameRate {
    ...
    public JObject ToJson() {
        JObject value = new JObject();
        value.Add("Numerator", Numerator);
        value.Add("Denominator", Denominator);
        return value;
    }

}
// Scriptclass CoreUObject.FrameTime
// Size: 0x08 (Inherited: 0x00)
...
public struct FFrameNumberRange {
    ...
    public JObject ToJson() {
        JObject value = new JObject();
        value.Add("LowerBound", LowerBound.ToJson());
        value.Add("UpperBound", UpperBound.ToJson());
        return value;
    }
