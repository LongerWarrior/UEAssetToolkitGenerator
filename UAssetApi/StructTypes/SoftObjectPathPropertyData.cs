...
public class SoftObjectPathPropertyData : PropertyData
{
    ...
    public override void Read(AssetBinaryReader reader, bool includeHeader, long leng1, long leng2 = 0)
    {
        ...
        if (reader.Ver < UE4Version.VER_UE4_ADDED_SOFT_OBJECT_PATH)
        {
    ...
    public override JToken ToJson() {
        ...
        if (Path != null) {
            res.Add(new JProperty("Path", Path.ToString()));
        } else {
            res.Add(new JProperty("AssetPathName", AssetPathName.ToName()));
            if (SubPathString != null) {
                res.Add(new JProperty("SubPathString", SubPathString.ToString()));
            } else {
                res.Add(new JProperty("SubPathString", ""));
            }
        }
